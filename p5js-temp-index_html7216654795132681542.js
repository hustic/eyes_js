...
function draw() {
  ...
  if (mouseX > 0 && mouseX < width &&
      mouseY > 0 && mouseY < height) {
  ellipse(map(mouseX, 0, width, x-15, x+15), map(mouseY, 0, height, y+13, y+25), 20, 20);
  ellipse(map(mouseX, 0, width, x+115, x+145), map(mouseY, 0, height, y+13, y+25), 20, 20);
 
      } else {
  ellipse(x, y+18, 20, 20);
